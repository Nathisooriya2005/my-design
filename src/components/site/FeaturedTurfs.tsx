            ...
            <div className="p-5">
              ...
              <div className="mt-5 flex items-center justify-between">
                ...
                <button
                  ...
                  onClick={() => setActive(t)}
                  className="px-4 py-2.5 rounded-xl text-sm font-semibold bg-gradient-to-r from-primary to-primary-glow text-primary-foreground hover:opacity-90 transition shadow-[var(--shadow-glow)] disabled:opacity-40 disabled:cursor-not-allowed"
                >
                  Book now
                </button>
              </div>
